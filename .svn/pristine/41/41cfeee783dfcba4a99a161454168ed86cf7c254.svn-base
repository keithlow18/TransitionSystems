...
public class Visualization {
	...
	@Plugin(name = "Show Transition System", returnLabels = { "Visualization for Transition System" }, returnTypes = { JComponent.class }, parameterLabels = { "Transition System" }, userAccessible = false)
	@Visualizer
