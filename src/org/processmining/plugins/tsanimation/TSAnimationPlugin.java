...
@Plugin(name = "Animate Transition System", parameterLabels = {
		"Transition System with Event Payload", "Log" }, returnLabels = { "Transition System Animation" }, returnTypes = { TSAnimation.class }, userAccessible = true)
