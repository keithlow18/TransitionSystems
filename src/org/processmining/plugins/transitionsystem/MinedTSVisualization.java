...
public class MinedTSVisualization {
	...
	@Plugin(name = "Show Mined Transition System", returnLabels = { "Visualization of Mined Transition System" }, returnTypes = { JComponent.class }, parameterLabels = { "Transition System" }, userAccessible = false)
	@Visualizer
