...
@Plugin(name = "Mine Transition System", parameterLabels = { "Log", "Event Classifiers", "Transition Classifier",
		"Settings" }, returnLabels = { "Mined Transition System", "Weights", "Start states", "Accept states" }, returnTypes = {
		TSMinerTransitionSystem.class, DirectedGraphElementWeights.class, StartStateSet.class, AcceptStateSet.class }, userAccessible = true)
public class TSMinerPlugin {
	...
	public static Object[] main(final PluginContext context, final XLog log) {
		...
		classifiers[1] = new XEventResourceClassifier();
		classifiers[2] = new XEventLifeTransClassifier();
		XEventClassifier transitionClassifier = new XEventAndClassifier(new XEventNameClassifier(), new XEventLifeTransClassifier());
		return main(context, log, classifiers, transitionClassifier);
	}
